      ...
      <ol class="max-w-screen-xl w-full mx-auto px-4 flex space-x-4 sm:px-6 lg:px-8">
        ...
        <li class="flex">
          <div class="flex items-center">
            ...
            <a href="#" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700" aria-current="page">Roles</a>
          </div>
        </li>
      </ol>
    </nav>
    ...
    <div class="flex">
      <div class="flex-none w-16 h-16">
        <div class="px-4 sm:px-6 md:px-0">
          <h1 class="text-3xl font-extrabold text-gray-900">Roles</h1>
        </div>
      </div>
  ...
  export default {
    ...
    const del = async (id: number) => {
      ...
      if(confirm('Are you sure you want to delete this record?')){
        ...
        roles.value = roles.value.filter((u: Entity) => u.id !== id);
      }
    };
